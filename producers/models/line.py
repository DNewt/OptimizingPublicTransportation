...
#################################################################
# A Line has a designated color - blue / red / green            #
# It contains many stations and trains                          #
# It manages the movement of its trains between its stations    # 
#################################################################
class Line:
    ...
    # Starts by creating Station object for first Station and then  # 
    # builds a Station object for each Station onwards.             #
    #################################################################
    ...
    ######################################################################
    # Constructs all trains on the line.                                 #
    # Creates a train with an ID (example: BL003) and Status             # 
    # Sends a message from the Station the train is created at initially #
    ######################################################################
